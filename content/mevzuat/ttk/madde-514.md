...
1. Döneme ait finansal durum tablosu (bilanço) [6],
2. Kâr veya zarar ve diğer kapsamlı gelir tablosu [6],
3. Özkaynak değişim tablosu [6],
4. Nakit akış tablosu [6],
5. Önemli muhasebe politikalarını ve diğer açıklayıcı bilgileri içeren dipnotlardan [6] oluşmaktadır.
