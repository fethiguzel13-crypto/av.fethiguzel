...
/** Kategoriye özgü süreç ipuçları — şablon tekdüzeliğini kırar (SEO + okunabilirlik). */
const CAT_HINTS = {
  Aile: {
    merciler: 'aile mahkemesi, nüfus müdürlüğü, 6284 mercileri ve gerektiğinde savcılık',
    belgeler: 'nüfus kayıt örneği, evlilik/boşanma belgeleri, gelir belgeleri, çocukla ilgili raporlar',
    risk: 'nafaka-velayet süreleri ve koruma kararının ihlali',
  },
  İş: {
    merciler: 'arabuluculuk bürosu, iş mahkemesi, SGK ve Çalışma ve İş Kurumu',
    belgeler: 'iş sözleşmesi, bordro, SGK hizmet dökümü, fesih bildirimi, yazışmalar',
    risk: 'işe iade ve işçilik alacaklarında gün bazlı hak düşürücü süreler',
  },
  İcra: {
    merciler: 'icra dairesi, icra mahkemesi ve gerektiğinde genel mahkemeler',
    belgeler: 'ödeme emri, takip dosyası dökümü, dekont, senet/çek, tebligat mazbataları',
    risk: 'ödeme emrine itirazda 7 günlük süre ve haciz sonrası gecikme',
  },
  Kira: {
    merciler: 'arabuluculuk (kira uyuşmazlıkları), sulh/asliye hukuk ve icra dairesi',
    belgeler: 'kira sözleşmesi, ödeme dekontları, ihtarnameler, tahliye taahhüdü',
    risk: 'kira artışı, tahliye ve depozito uyuşmazlıklarında delil eksikliği',
  },
  Tüketici: {
    merciler: 'tüketici hakem heyeti, tüketici mahkemesi ve banka/kurum müşteri hizmetleri',
    belgeler: 'fatura, sipariş-kargo, garanti, mesafeli satış bilgilendirme, yazışma',
    risk: 'parasal sınır, başvuru süresi ve ayıp ihbar süreleri',
  },
  Miras: {
    merciler: 'noter, sulh hukuk (veraset), asliye hukuk ve tapu müdürlüğü',
    belgeler: 'ölüm belgesi, nüfus kayıt, veraset ilamı, tapu, vasiyet',
    risk: 'red süresi, saklı pay ve muris muvazaası ispatı',
  },
  Eşya: {
    merciler: 'tapu müdürlüğü, kadastro, asliye hukuk ve icra',
    belgeler: 'tapu kaydı, sözleşme, vekâlet, imar/iskan, ödeme makbuzları',
    risk: 'şekil şartı, önalım süresi ve sahte işlemler',
  },
  Ceza: {
    merciler: 'kolluk, Cumhuriyet savcılığı, sulh ceza hâkimliği ve ceza mahkemeleri',
    belgeler: 'şikâyet dilekçesi, delil dökümü, tıbbi rapor, ekran görüntüleri',
    risk: 'şikâyet süresi, zamanaşımı ve soruşturma gizliliği',
  },
  Usul: {
    merciler: 'görevli-yetkili mahkeme, arabuluculuk ve kanun yolu mercileri',
    belgeler: 'dilekçe, tebligat, harç makbuzu, delil listesi, tutanaklar',
    risk: 'görev-yetki, harç-avans ve istinaf/temyiz süreleri',
  },
  İdare: {
    merciler: 'idare, üst makam, idare/vergi mahkemesi ve Danıştay (kanun yolu)',
    belgeler: 'idari işlem, tebliğ, başvuru cevabı, CİMER/bilgi edinme evrakı',
    risk: 'dava açma süreleri ve yürütmenin durdurulması şartları',
  },
  Trafik: {
    merciler: 'emniyet/jandarma, GİB/e-Devlet ceza, sulh ceza ve hukuk mahkemeleri, sigorta',
    belgeler: 'ceza tebliği, kaza tutanağı, poliçe, eksper, ruhsat-ehliyet',
    risk: 'itiraz süreleri, ceza puanı ve kusur tespiti',
  },
  Vergi: {
    merciler: 'vergi dairesi, GİB, uzlaşma mercileri ve vergi mahkemesi',
    belgeler: 'beyanname, tahakkuk, ödeme, inceleme tutanağı, yapılandırma',
    risk: 'ödeme-vade, ceza indirimi ve dava süreleri',
  },
  'Sosyal Güvenlik': {
    merciler: 'SGK, e-Devlet, işkur ve iş mahkemesi (uyuşmazlıkta)',
    belgeler: 'hizmet dökümü, prim, rapor, borçlanma evrakı',
    risk: 'prim günü, başvuru usulü ve süre kaçırma',
  },
  Mevzuat: {
    merciler: 'mevzuat metni, akademik şerh ve içtihat taraması',
    belgeler: 'kanun maddesi metni, değişiklik tarihleri, ilgili yönetmelik',
    risk: 'yürürlük tarihi ve madde numarasının yanlış okunması',
  },
  Nüfus: {
    merciler: 'nüfus müdürlüğü, e-Devlet ve gerektiğinde mahkeme',
    belgeler: 'kimlik, adres, kayıt örneği, randevu belgesi',
    risk: 'yanlış beyan ve süreye bağlı işlemler',
  },
  Yabancılar: {
    merciler: 'Göç İdaresi, çalışma izni mercileri ve idari yargı',
    belgeler: 'pasaport, ikamet, evlilik, randevu ve tebligat',
    risk: 'süre aşımı, ret ve sınır dışı itiraz süreleri',
  },
  Sigorta: {
    merciler: 'sigorta şirketi, tahkim ve hukuk mahkemesi',
    belgeler: 'poliçe, ihbar, eksper, red yazısı, hasar fotoğrafları',
    risk: 'ihbar süresi ve poliçe istisnaları',
  },
  Sağlık: {
    merciler: 'sağlık kurumu, savcılık/mahkeme (malpraktis) ve SGK',
    belgeler: 'tıbbi dosya, onam, rapor, fatura',
    risk: 'zamanaşımı ve ispat (bilirkişi)',
  },
  'Engelli Hakları': {
    merciler: 'sağlık kurulu, belediye, SGK ve ilgili bakanlık birimleri',
    belgeler: 'engelli raporu, oran, kimlik, gelir belgeleri',
    risk: 'rapor güncelliği ve muafiyet şartları',
  },
  Ticaret: {
    merciler: 'ticaret sicili, arabuluculuk, ticaret/asliye ticaret mahkemesi',
    belgeler: 'ana sözleşme, fatura, defter, çek/senet, yazışma',
    risk: 'ticari iş karinesi, fatura itirazı ve şirket sorumluluğu',
  },
  Borçlar: {
    merciler: 'arabuluculuk (kapsamdaysa), hukuk mahkemesi ve icra',
    belgeler: 'sözleşme, dekont, ihtar, yazışma, senet',
    risk: 'zamanaşımı, şekil ve ispat',
  },
  İmar: {
    merciler: 'belediye, yapı denetim, idare mahkemesi',
    belgeler: 'ruhsat, imar durumu, tutanak, para cezası tebliği',
    risk: 'itiraz ve yıkım/mühürleme süreleri',
  },
  Eğitim: {
    merciler: 'okul/üniversite idaresi, YÖK ve idari yargı',
    belgeler: 'kayıt, ödeme, disiplin, sözleşme',
    risk: 'itiraz süreleri ve tüketici-idare ayrımı',
  },
  'Kişisel Veri': {
    merciler: 'veri sorumlusu, Kişisel Verileri Koruma Kurulu ve yargı',
    belgeler: 'başvuru, cevap, ihlal bildirimi, aydınlatma metni',
    risk: '30 günlük cevap süresi ve ispat',
  },
};

function genericBody(t) {
  const k0 = t.keywords[0] || t.h1;
  const k1 = t.keywords[1] || t.keywords[0] || t.h1;
  const k2 = t.keywords[2] || k1;
  const cat = t.category;
  const hint = CAT_HINTS[cat] || {
    merciler: 'ilgili idare, arabuluculuk, icra veya mahkeme',
    belgeler: 'kimlik, sözleşme, tebligat ve ödeme belgeleri',
    risk: 'süre kaçırma ve yanlış mercie başvuru',
  };
  const topicClean = t.h1.replace(/\?$/, '');

  const lead = `${topicClean}, Türkiye’de arama motorlarında «${k0}» ve «${k1}» ifadeleriyle en çok sorulan konulardan biridir. Bu rehber; tanım, muhataplar, adımlar, belgeler, süreler ve sık hatalar üzerinden sade bir yol haritası sunar. Metin bağlayıcı hukuki tavsiye yerine geçmez; yürürlükteki mevzuat, tebliğ tarihi ve somut dosya esastır. Portalda madde metni ve akademik şerh için mevzuat aramasını, hesaplama için ilgili araçları kullanabilirsiniz.`;

  const sections = [
    s(`${cat} açısından «${k0}» ne anlama gelir?`, [
      `${t.h1} sorusu, ${cat.toLocaleLowerCase('tr-TR')} alanında hak ve yükümlülüklerin doğru teşhis edilmesiyle başlar. Kullanıcılar «${k0}» aramasında hem tanımı hem de «şimdi ne yapmalıyım?» cevabını arar.`,
      `Yanlış mercie gitmek veya süre kaçırmak en sık hak kaybı sebebidir. Bu yüzden önce olayın niteliği (idari mi, özel hukuk mu, ceza mı, icra mı) netleştirilmelidir. İlgili anahtar kelimeler: ${t.keywords.slice(0, 3).join(', ')}.`,
    ], t.keywords.slice(0, 4)),
    s('Kimler muhataptır? Hangi şartlar aranır?', [
      `Tipik muhataplar: ${hint.merciler}. Şartlar dosyaya göre değişir; süre, şekil, belgeler ve bazen arabuluculuk veya idari ön başvuru aranır.`,
      `Eksik belge veya usulsüz tebligat sonraki itiraz ve dava aşamalarını doğrudan etkiler. Tebliğ / öğrenme tarihini yazılı olarak sabitleyin; «${k2}» ile ilgili tüm yazışmaları saklayın.`,
    ]),
    s('Adım adım süreç nasıl işler?', [
      `Genel akış: (1) olay ve belgeleri derlemek, (2) doğru merci ve süreyi belirlemek, (3) yazılı başvuru / dilekçe / arabuluculuk yapmak, (4) tebligat ve sonucu takip etmek, (5) ret veya aleyhe sonuçta itiraz / istinaf / dava yolunu değerlendirmek.`,
      `e-Devlet, UYAP, GİB, belediye ve banka panelleri birçok adımı hızlandırır. Barkodlu elektronik belge ile ıslak imzalı suret ayrımına kurum bazında dikkat edin. «${k0}» için somut süreler dönemsel mevzuata bağlıdır.`,
    ]),
    s('Sık yapılan hatalar ve riskler', [
      `En yaygın riskler: süreleri kabaca hesaplamak, yanlış mercie başvurmak, delilleri saklamamak, sözlü anlaşmaya güvenmek ve ödeme/indirim metnini okumadan işlem yapmak. ${cat} dosyalarında özellikle ${hint.risk} kritiktir.`,
      `İnternetteki «garanti sonuç» vaatleri bağlayıcı değildir. Bu sayfa bilgilendirme amaçlıdır; sonuç vaadi içermez.`,
    ]),
    s('Hangi belgeler ve deliller işe yarar?', [
      `Bu konuda sık kullanılan belgeler: ${hint.belgeler}. Ayrıca kimlik, tebligat mazbataları, ödeme dekontları, mesaj/e-posta çıktıları ve tanık listesi tamamlayıcı olabilir.`,
      `Dijital delillerde tarih damgası ve bütünlük korunmalıdır. Resmî kayıtlara (tapu, SGK, icra, belediye) mümkün olduğunca asıl veya onaylı suret üzerinden erişin.`,
    ]),
    s('Portalda madde, şerh ve hesaplama', [
      `Kanun maddesi ve akademik şerh aramak için sitedeki mevzuat aramasını kullanın; «${k0}» ile ilişkili kavramlar ve hesaplama araçları ilgili bağlantılarda yer alır.`,
      `Madde numarası biliyorsanız doğrudan /mevzuat/{kanun}/{madde} yolunu, bilmiyorsanız /ara üzerinden tam metin aramayı tercih edin. Bu rehberler ana sayfada öne çıkarılmaz; arama motoru ve site içi dizin üzerinden erişilir.`,
    ]),
  ];

  const steps = [
    `«${k0}» ile ilgili tebliğ, sözleşme, dekont ve yazışmaları tek klasörde toplayın.`,
    'Tebliğ veya öğrenme tarihini not edin; yasal süreyi bu tarihten hesaplayın.',
    `Doğru mercie yönelin: ${hint.merciler}.`,
    'Yazılı başvuru / dilekçe / arabuluculuk kaydı oluşturun; başvuru numarasını saklayın.',
    'Sonucu e-Devlet, UYAP veya kurum paneli üzerinden takip edin; itiraz süresini kaçırmayın.',
  ];

  const faqList = [
    faq(`«${k0}» için avukat zorunlu mu?`, 'Çoğu başvuruda avukat zorunlu değildir; ancak süre ve usul hataları hak kaybına yol açabileceğinden karmaşık veya yüksek riskli dosyalarda hukuki destek önerilir.'),
    faq(`«${k1}» işlemi ne kadar sürer?`, 'Kurum ve mahkeme yoğunluğu, delil durumu ve itirazlara göre değişir. Kesin süre vaadi verilemez.'),
    faq('e-Devlet veya UYAP yeterli midir?', 'Birçok işlem elektronik kanalla başlar veya tamamlanır; bazı merciler hâlâ fiziki evrak, noter veya randevu ister.'),
    faq(`«${k0}» konusunda bu rehber bağlayıcı mıdır?`, 'Hayır. Genel bilgilendirmedir; yürürlükteki mevzuat, içtihat ve somut olay esastır.'),
    faq('Kanun maddesinin tam metnini nerede bulurum?', 'Av. Fethi Güzel Hukuk Portalı mevzuat bankasında madde metni ve akademik şerh birlikte sunulur: https://www.avfethiguzel.com/ara ve https://www.avfethiguzel.com/mevzuat'),
  ];
...
function buildArticle(t) {
  const b = BODIES[t.seed] || genericBody(t);
  return {
    slug: t.slug,
    title: t.title,
