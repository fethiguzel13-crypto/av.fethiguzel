...
OUT = ROOT / "docs" / "ders-notlari" / "notebooklm" / "dalga-a-miras-hukuku"
GRAPH = ROOT / "lib" / "ders-notlari" / "graphs" / "miras-hukuku.json"
...
def main() -> None:
    ...
    parts = ["# Miras hukuku — resmi lafız (FSEK m. 31)\n", "Şerh yoktur. TMK.\n"]
    seen = set()
    ...
    (OUT / "harita.md").write_text(
        """# Dalga A — Miras hukuku

Quiz TMK lafzı ve graf unsura dayanır. Künye uydurulmaz. Slayt yoktur.

Kurum id: yasal-mirascilik, sakli-pay, olume-bagli-tasarruf, miras-sozlesmesi, iptal, tenkis, ret, tereke-paylasma.

Tuzaklar: zümre/eş payı; saklı pay/yasal pay; el yazısı/resmi vasiyet; vasiyet/miras sözleşmesi; iptal/tenkis; ret süresi.
