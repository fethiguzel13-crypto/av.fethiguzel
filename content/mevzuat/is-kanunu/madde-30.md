...
keywords:
  ...
  - "eski hükümlü kontenjanı"
  - "terör mağduru istihdamı"
  - "malullük sonrası işe alım"
  - "hazine prim teşviki"
---
...
- **Özel Sektör İşyerlerinde**: Yalnızca **%3 engelli** çalıştırma zorunluluğu vardır. Eski hükümlü veya terör mağduru çalıştırma zorunluluğu özel sektörde bulunmamaktadır (5763 sayılı Kanun değişikliğiyle kaldırılmıştır).
- **Kamu İşyerlerinde**: **%4 engelli** ve **%2 eski hükümlü** (veya terör mağduru) çalıştırma zorunluluğu vardır.
...
- **Yuvarlama Kuralı**: Matematiksel oranın hesaplanmasında yarım ve daha fazla olan kesirler tama dönüştürülür; yarımdan az olan kesirler dikkate alınmaz. Örneğin, 50 işçisi olan özel sektör işyerinde: 50 x %3 = 1.5 işçi yapar. Yarım (0.5) tama yuvarlanacağından işveren 2 engelli çalıştırmak zorundadır. 49 işçisi olan il bazındaki bir şirket ise baraja takılmadığından yükümlü değildir.
...
- **Kontenjanda Öncelik**: İşyerinin işçisi iken engelli hale gelenlere kontenjan alımlarında öncelik tanınır (m. 30/2).
- **Malullüğü Ortadan Kalkanların İşe Alınma Borcu**: Malulen ayrılan işçi iyileşirse, eski işyerine başvurabilir. İşveren boş yer varsa derhal, yoksa ilk boşalacak pozisyona eski işçisini tercih etmek zorundadır. Bu zorunluluğa uymayan işveren, eski işçisine **altı aylık ücret tutarında tazminat** ödemekle yükümlü olur (m. 30/5). Bu tazminat, akit yapma zorunluluğunun ihlalinden doğan özel bir tazminattır.
...
- **İş Kanunu m. 101** — Kontenjan yükümlülüğüne uymama cezası. 30. maddeye aykırı olarak engelli çalıştırmayan işverene, m. 101 uyarınca çalıştırmadığı her engelli ve çalıştırılmayan her ay için çok ağır idari para cezası kesilir.
- **5378 sayılı Engelliler Hakkında Kanun** — Engellilerin hakları, tanımları ve istihdam süreçlerine ilişkin genel esaslar 30. maddeyle doğrudan uyuşum halindedir.
- **Sosyal Sigortalar ve Genel Sağlık Sigortası Kanunu (5510 sayılı Kanun)** — Prime esas kazanç, işveren hissesi ve Hazine teşviklerinin uygulanması 5510 sayılı Kanun hükümleriyle entegre şekilde yürütülür.

#### 4. Uygulama: Yargıtay İçtihadı

**Yargıtay 9. Hukuk Dairesi, E. 2025/1612, K. 2025/7823, T. 03.11.2025**

> Kararda, iş kazası sonucu malulen ayrılmak zorunda kalan ancak 2 yıl süren tedavinin ardından malullüğü tamamen ortadan kalkan fabrika işçisinin, eski işyerine başvurarak işe alınmasını talep ettiği olay ele alınmıştır. İşveren boş pozisyon bulunmadığını gerekçe göstererek işçiyi işe almamış ve tazminat ödemeyi de reddetmiştir. Daire, 4857 sayılı İş Kanunu’nun 30/5. maddesi uyarınca işverenin boş yer olmasa dahi **boşalacak ilk işe başka isteklilere tercih ederek** işçiyi o andaki şartlarla işe almak zorunda olduğunu; bu yükümlülüğü ihlal etmesi halinde işçiye netleşen 6 aylık ücreti tutarında tazminat ödeme yükümlülüğünün kesin olduğunu vurgulamıştır. İşverenin işe alma borcunu ihlal ettiği gerekçesiyle yasal 6 aylık tazminatın işçiye ödenmesi yönündeki yerel mahkeme kararı onanmıştır.
...
- **İŞKUR Aracılığı Zorunludur**: İşverenler engelli kadrolarını kendileri serbestçe dolduramazlar; alımların mutlaka **Türkiye İş Kurumu (İŞKUR) aracılığıyla** yapılması ve tescil edilmesi gerekir.
- **İl Bazında Takip**: Şirketler, İK planlamasında aynı ildeki tüm şubelerin işçi sayılarını aylık olarak konsolide etmeli ve 50 sınırına ulaşıldığı an İŞKUR'a başvurarak engelli kadrosu açmalıdır.
- **SGK Teşvik Kodları**: Engelli istihdam teşviklerinden (işveren payının Hazinece karşılanması) yararlanabilmek için aylık prim ve hizmet belgelerinin yasal sürede verilmesi ve sigortalı hisselerinin düzenli ödenmesi şarttır.
- **Sık Yapılan Hatalar**: Engelli kontenjanını doldurmamak amacıyla işçileri taşeron (alt işveren) üzerinden göstermek; asıl işveren-alt işveren muvazaası durumunda alt işverenin işçileri baştan itibaren asıl işverenin işçisi sayılacağından (m. 2), kota hesabı değişecek ve geriye dönük cezalar kesilecektir.
...
- *Doktrin*: Sarper Süzek (*İş Hukuku*), Nuri Çelik / Nurşen Caniklioğlu / Talat Canbolat (*İş Hukuku Dersleri*), Hamdi Mollamahmutoğlu / Muhittin Astarlı / Ulaş Baysal (*İş Hukuku*), Haluk Hadi Sümer (*İş Hukuku Dersleri*) ders çalışmaları.
- *Yargıtay kararları*: Yargıtay 9. Hukuk Dairesi'nin 03.11.2025 tarihli E. 2025/1612, K. 2025/7823 sayılı kararı (maluliyeti ortadan kalkan eski işçiyi işe almama tazminatı kriterleri).
- *Mevzuat*: 4857 sayılı İş Kanunu yürürlükteki metni; m. 2, m. 101, 5510 sayılı Sosyal Sigortalar Kanunu prime esas kazanç kuralları ve 5378 sayılı Engelliler Kanunu.
