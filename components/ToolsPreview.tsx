...
const FEATURED_TOOLS = [
  ...
  },
  {
    ...
    icon: '🔏',
    baslik: 'Saklı Pay',
    aciklama: 'Vasiyet planı için saklı pay ve tasarruf nisabı.',
    etiket: 'Miras Hukuku',
  },
  {
    id: 'kidem',
    ...
    aciklama: 'Giydirilmiş ücret, tavan, damga ve gelir vergisi.',
    etiket: 'İş Hukuku',
  },
  {
    id: 'kidem-ise-iade',
  ...
  },
  {
    ...
    icon: '📆',
    baslik: 'Süre Hesabı',
    aciklama: 'Tebliğden istinaf, temyiz, itiraz son günü.',
    etiket: 'Usul',
  },
  {
    id: 'mal-rejimi',
    icon: '💍',
    baslik: 'Mal Rejimi',
    aciklama: 'Edinilmiş mallara katılma ve artı değer.',
    etiket: 'Aile Hukuku',
  },
  {
    id: 'vekalet',
    ...
    aciklama: 'AAÜT 2026 nispi / maktu basamakları.',
    etiket: 'Dava Masrafı',
  },
  {
    id: 'kira-tespit',
