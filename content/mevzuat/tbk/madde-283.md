...
(A), mülkiyetindeki bir sanat eseri (tablo) ile (B)'nin mülkiyetindeki antika bir vazonun değiştirilmesi hususunda bir mal değişim (trampa) sözleşmesi imzalamıştır. Sözleşmenin ifasından sonra (B)'nin teslim ettiği vazonun replika (sahte) olduğu anlaşılmıştır.
