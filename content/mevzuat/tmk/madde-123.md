...
**Olay 1 (kurmaca senaryo):** (A) ve (B) arasındaki nişanlılık, tarafların aileleri arasında
...
**Olay 2 (kurmaca senaryo):** Nişanlı çift (X) ve (Y)'den (X) 15 Mayıs 2024 tarihinde geçirdiği
