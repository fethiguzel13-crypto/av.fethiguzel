...
1. **İtiraz (Einwendung):** Bir hakkın hiç doğmadığını (örneğin ehliyetsizlik, 
...
2. **Def'i (Einrede):** Hakkın doğduğunu ve geçerli olduğunu kabul etmekle 
...
1. Borçlunun alacağı, devri öğrendiği anda muaccelse: Takas edebilir.
2. Borçlunun alacağı, devri öğrendiği anda henüz muaccel değilse: Borçlunun 
