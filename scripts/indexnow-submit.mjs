...
const PRIORITY = [
  ...
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/sigorta-hukuku-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/sigorta-hukuku-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/sigorta-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/sigorta-hukuku-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/sigorta-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ticari-isletme-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ticari-isletme-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ticari-isletme-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ticari-isletme-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/ticari-isletme-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-genel-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-genel-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-genel-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-genel-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/ceza-genel-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-ozel-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-ozel-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-ozel-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/ceza-ozel-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/ceza-ozel-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/cmk-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/cmk-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/cmk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/cmk-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/cmk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idare-hukuku-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idare-hukuku-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idare-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idare-hukuku-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/idare-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idari-yargilama-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idari-yargilama-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idari-yargilama-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/idari-yargilama-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/idari-yargilama-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-felsefesi-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-felsefesi-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-felsefesi-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-felsefesi-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/hukuk-felsefesi-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-ingilizcesi-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-ingilizcesi-donem-2`,
  ...
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/tuketici-hukuku-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/tuketici-hukuku-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/tuketici-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/tuketici-hukuku-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/tuketici-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/insaat-hukuku-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/insaat-hukuku-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/insaat-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/insaat-hukuku-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/insaat-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/arabuluculuk-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/arabuluculuk-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/arabuluculuk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/arabuluculuk-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/arabuluculuk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/devletler-ozel-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/devletler-ozel-donem-2`,
  ...
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/anayasa-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/anayasa-donem-2`,
  ...
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/milletlerarasi-hukuk-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/milletlerarasi-hukuk-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/milletlerarasi-hukuk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/milletlerarasi-hukuk-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/milletlerarasi-hukuk-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-sosyolojisi-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-sosyolojisi-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-sosyolojisi-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/hukuk-sosyolojisi-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/hukuk-sosyolojisi-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/is-hukuku-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/is-hukuku-donem-2`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/is-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/is-hukuku-donem-1/pdf`,
  `https://${HOST}/ders-notlari/marmara/is-hukuku-yillik`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/adli-tip-donem-1`,
  `https://${HOST}/ders-notlari/ankara-yildirim-beyazit/adli-tip-donem-2`,
