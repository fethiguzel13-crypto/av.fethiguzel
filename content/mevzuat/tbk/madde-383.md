...
- **TBK m. 379 ve 380 (Kullanım Ödüncünün Sınırları)**: TBK m. 383, m. 379'daki "kullandıktan sonra geri verme" asli edimi `[1]` ile m. 380'deki "şahsen ve amaca uygun kullanma" külfetinin `[1]` ihlaline bağlanan yaptırımı sistematik bir bütünlük içinde düzenler. 
- **TBK m. 384 ile Karşılaştırma**: Amacı ve süresi belirlenmemiş kullanım ödüncünde ödünç veren, eşyayı dilediği zaman geri isteyebilir `[2]`. Oysa TBK m. 383'te, amaç belirli olduğu için ödünç veren kural olarak bu amacın gerçekleşmesini beklemek zorundadır; ancak fıkradaki istisnai haller (aykırı kullanım, ivedi ihtiyaç) doğduğunda erken talep hakkı elde eder `[2]`.
- **TBK m. 386 vd. (Tüketim Ödüncü / Mutuum)**: Kullanım ödüncünde mülkiyet devredilmediği için (aynen iade borcu vardır) eşyanın hor kullanılması veya başkasına verilmesi derhal geri isteme hakkı doğurur. Oysa tüketim ödüncünde (karz) paranın veya misli eşyanın mülkiyeti ödünç alana geçer `[6], [7]`. Bu nedenle, mutuum sözleşmesinde TBK m. 383'teki gibi "başkasına kullandırma nedeniyle derhal iade" gibi bir kurgu mümkün değildir.
