...
- **Yaygın uygulama hataları**: 
  1) Kambiyo senetlerinin (çek, bono, poliçe) iptali süreçlerinde TTK m. 661'in doğrudan uygulanmaya çalışılması temel bir hatadır. Kambiyo senetleri için TTK m. 757 vd. hükümleri uygulama alanı bulur [21, 35, 36]. 
  2) Hamiline yazılı anonim şirket pay senedini devralmasına rağmen MKK'ya bildirim yapmayan (TTK m. 489) kişinin açtığı iptal davasında, hak sahipliğinin (aktif husumet) salt senedin fiziksel kopyasının sunulması ile ispat edilebileceğinin düşünülmesi güncel mevzuat karşısında hatalıdır.
