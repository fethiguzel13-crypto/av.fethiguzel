...
const veri: IlceVerisi = {
  ...
  neden: "Patnos'tan ofisimize ulaşmakta güçlük yaşayan müvekkillerimiz için telefon veya video görüşmesiyle ön değerlendirme yapılabilir. Süreç boyunca evrak paylaşımı dijital ortamda kolaylaştırılır ve dosyanızın her aşamasında açık, düzenli bilgilendirme sağlanır.",
};
