...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Yerleşim URL’leri (`/ercis-avukat` vb.) artık bölgesel bilgilendirme sayfasıdır.
      // 308 ile deneme yazısına göndermek Google’da isim–yerleşim eşlemesini koparıyordu.
    ];
  },
  async rewrites() {
