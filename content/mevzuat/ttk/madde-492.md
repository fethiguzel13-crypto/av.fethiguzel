...
- **Yaygın uygulama hataları**: 
  (1) Hamiline yazılı paylar için esas sözleşmeye bağlam kuralı konulması ve bunun Ticaret Sicili tarafından sehven tescil edilmesi. (Bu tür hükümler mutlak butlanla batıldır) [11, 12]. 
  (2) Pay senedi üzerinde "rehin" kurulurken şirket onayının aranması. TTK m. 492/2 bağlamı sadece intifa hakkına teşmil etmiş, rehin hakkını kapsam dışı bırakmıştır [13].
  (3) Şirketin onay talebini reddederken muhataba payları gerçek değerinden alacağını önermeksizin soyut bir ret işlemi yapması (haklı sebep olmaksızın çıplak ret kararı verilmesi geçersizdir) [3, 19].
