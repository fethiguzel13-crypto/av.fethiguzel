...
OUT = ROOT / "docs" / "ders-notlari" / "notebooklm" / "dalga-a-aile-hukuku"
GRAPH = ROOT / "lib" / "ders-notlari" / "graphs" / "aile-hukuku.json"
...
def main() -> None:
    ...
    parts = ["# Aile hukuku — resmi lafız (FSEK m. 31)\n", "Şerh yoktur. TMK.\n"]
    seen = set()
...
Kurum id: nisan, evlenme, butlan, bosanma, mal-rejimi, velayet, nafaka.

Tuzaklar: nişan/evlenme; mutlak/nispi butlan; m.166/1 ve m.166/3; edinilmiş/kişisel mal; velayet/nafaka; tedbir/yoksulluk nafakası.
