---
title: "Türk Ticaret Kanunu Madde 252"
...
**Olay 1 (Ortağın İflası ve Geçici Yönetim Krizi):**
A, B ve C'nin eşit paylarla kurduğu ABC Kollektif Şirketinde, ortaklardan B'nin şahsi ticari faaliyetlerinden kaynaklanan aşırı borçlanması neticesinde Asliye Ticaret Mahkemesince iflasına karar verilmiştir. İflas idaresi, şirketin yeni ihalelere girmesine karşı çıkarak derhal B'nin payının nakden masaya ödenmesini talep etmiş, A ve C ise şirketin devam eden büyük bir projesi olduğunu belirterek bu talebe anında yanıt verememişlerdir.
*Hukuki analiz:* Olayda TTK m. 252 bağlamında TBK m. 641 atfı devreye girer. İflas idaresi, B'nin yerine şirketin kalıcı bir yöneticisi olarak atanamaz. B'nin iflası, TTK m. 254 uyarınca diğer ortaklara müflis ortağı şirketten çıkarma hakkı verir. Çıkarma kararı alınana ve pay iflas masasına ödenene kadar geçecek sürede iflas idaresi sadece "geçici yönetim" yetkisine sahiptir. Bu yetki, şirketin rutin işleyişini ve olağan ticari faaliyetini (örneğin devam eden projeyi) durduracak şekilde kullanılamaz; sadece müflisin malvarlığı değerlerinin zarar görmesini engellemek maksadıyla sınırlı olarak icra edilebilir.

**Olay 2 (Ortağın Kısıtlanması ve Tasfiye Süreci):**
X ve Y tarafından yönetilen XY Kollektif Şirketinde, ortak X geçirdiği ağır bir kaza sonucu komaya girmiş ve TMK hükümleri uyarınca kısıtlanarak kendisine eşi Z vasi olarak atanmıştır. Y, X'in fiil ehliyetini kaybetmesini gerekçe göstererek şirketi tek başına yönetmeye başlamış ve şirkete ait bir taşınmazı üçüncü bir kişiye satmak istemiştir. Z ise vasi sıfatıyla bu satışa itiraz etmiştir.
*Hukuki analiz:* TTK m. 252 uyarınca X'in kısıtlanması sebebiyle TBK'nın geçici yönetime ilişkin hükümleri uygulanır,. Kısıtlanma tek başına şirketin doğrudan feshi sonucunu doğurmaz, ancak TTK m. 245/1-d uyarınca haklı sebeple fesih nedeni teşkil eder,. Şirket varlığını sürdürdüğü müddetçe, olağanüstü işlemlerde (örneğin şirketin taşınmazının satışı) ortakların oybirliği şarttır (TTK m. 223),. Ortak Y'nin bu işlemi tek başına yapma yetkisi yoktur. Vasi Z, kısıtlı X'i temsilen geçici yönetim kapsamında bu satışa muvafakat etmeme hakkına sahiptir. Taşınmazın satışı geçici yönetim sınırlarını aşan bir tasarruf işlemi olduğundan, ancak vesayet makamının izni ve hususi gereklilik halinde mümkündür.

#### 6. Pratik Uygulama Notları

- **İspat yükü**: Bir ortağın fiil ehliyetinin kısıtlandığı veya iflas ettiği hususunda ispat yükü, bunu iddia eden tarafa (diğer ortaklara, iflas idaresine veya vasiye) aittir. Bu olgu, ancak kesinleşmiş (veya icrası kabil) bir mahkeme kararı (vesayet kararı veya iflas kararı) ile ispat olunabilir. Geçici yönetimin sınırlarının aşıldığı iddiası ise TMK m. 6 uyarınca iddia eden tarafından genel ispat kurallarıyla kanıtlanmalıdır.
- **Zamanaşımı / Süreler**: Ortağın iflası veya kısıtlanması akabinde şirketten ayrılması (çıkarılması) halinde, eski ortağın (veya iflas masasının) şirketin borçlarından dolayı şahsi sorumluluğu, ayrılmanın Türkiye Ticaret Sicili Gazetesinde (TTSG) tescil ve ilanından itibaren üç yıl geçmekle zamanaşımına uğrar (TTK m. 264).
- **Görevli/yetkili mahkeme**: Şirketin feshine, ortağın çıkarılmasına veya geçici yönetimin yetkilerinin aşılması nedeniyle doğacak tazminat davalarına bakmakla görevli mahkeme, şirketin merkezinin bulunduğu yerdeki Asliye Ticaret Mahkemesidir (TTK m. 4 ve 5),,. Vesayet makamının iznini gerektiren idari tasarruflarda ise görevli mahkeme kısıtlının yerleşim yeri Sulh Hukuk Mahkemesidir.
- **Yaygın uygulama hataları**: Uygulamada en sık karşılaşılan hata, bir ortağın iflası veya kısıtlanması durumunda şirketin derhal ve kendiliğinden tasfiyeye girdiğinin zannedilmesidir. Oysa kanun koyucu, TTK m. 252 mekanizması ile tüzel kişiliğin devamlılığına öncelik tanımış ve diğer ortaklara durumu toparlama, müflisi/kısıtlıyı ortaklıktan çıkarma fırsatı tanımıştır. Ayrıca, vasinin veya iflas masasının geçici yönetim yetkisini, şirketin genel kurulunda (ortaklar kurulunda) her türlü stratejik kararı veto etme yetkisi olarak algılaması da yaygın bir yanılgıdır; bu yetki tamamen koruma (muhafaza) amacıyla sınırlıdır.
