...
- **TTK m. 140 (Ortaklık Payının ve Haklarının Korunması):** Ara bilanço, birleşmede pay sahiplerine tahsis edilecek payların değişim oranının adil bir biçimde hesaplanması (TTK m. 140/1) için temel veri setini oluşturur [10, 17]. Değer tespiti ve oranlama, doğrudan bu güncel tablo üzerinden gerçekleştirilir.
