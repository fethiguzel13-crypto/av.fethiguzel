...
Belçika'da yerleşik (X), Brüksel'de düzenlediği çeki, İtalyan (Y)'ye vermiş; İtalya'da ikamet eden (Z), (X)'in borcuna teminat olmak üzere senedin ön yüzüne imza atarak İtalya'da aval vermiştir.
*Hukuki analiz:* 
Aval kurumuna uygulanacak hukuk kuralı uyarınca, (Z)'nin aval taahhüdünün sonuçları, imzanın fiilen senede yansıtıldığı **İtalyan hukukuna** göre belirlenecektir (TTK m. 821) [3]. Asıl borçlu (X)'in keşideci sıfatıyla borçlanmasının sonuçları ise işlemin yapıldığı yer olan **Belçika hukukuna** göre değerlendirilecektir.
