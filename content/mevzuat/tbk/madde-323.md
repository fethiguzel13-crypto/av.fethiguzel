...
- **Yaygın uygulama hataları:** 
  1. İşyeri devri (TTK m. 11) gerçekleştirildiğinde kira sözleşmesinin de kendiliğinden (ipso iure) ve şartsız olarak devralana geçtiğinin zannedilmesi.
  2. Kiraya verenin, kefillerden yeni bir yazılı onay (icazet) almadan devir işlemine onay vermesi sonucunda, devir sonrasında doğacak borçlar (işyeri kiralarındaki 2 yıllık devreden sorumluluğu aşan kısımlar) için kefile başvuramaması [9, 10, 15].
  3. Konut kiralarında da "haklı sebep yoksa rızadan kaçınılamaz" zannıyla devir işleminin yapılabileceğinin düşünülmesi. Bu kural sadece işyeri kiralarına özgüdür.
