...
*Hukuki analiz:* TBK m. 201 uyarınca (C) ile alacaklı (B) arasında bir "Borca Katılma" sözleşmesi kurulmuştur [1]. İkinci fıkra gereği (C), (A) ile birlikte müteselsil borçlu statüsündedir [2]. TBK m. 163 gereği alacaklı (B), borcun ifasını dilerse sadece katılan (C)'den talep edebilir [5]. (C)'nin "önce asıl borçluya başvur (peşin dava defi)" şeklindeki savunması hukuki dayanaktan yoksundur.
