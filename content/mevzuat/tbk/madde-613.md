---
title: "Türk Borçlar Kanunu Madde 613"
...
##### 2.3. Tek Taraflı İstem Yetkisi ve Değerin Belirlenmesi
Kanuni ipotek hakkı, ölünceye kadar bakma sözleşmesinin yer aldığı resmi senedin içerisinde tescil talebi olarak yazılabileceği gibi, resmi senet tarihinden itibaren üç ay içinde tapu müdürlüğüne tek taraflı bir istemle de tesis edilebilir. Şayet bakım alacaklısı, ipoteğin taşınmazın resmi senette yazılı harca esas değeri üzerinden tesisini talep ederse, bakım borçlusunun muvafakatine veya bir mahkeme kararına ihtiyaç duyulmaz; tapu memuru tek taraflı beyanla ipoteği tescil etmekle mükelleftir. Ancak alacaklı, resmi senetteki değerden daha yüksek bir bedel üzerinden ipotek kurulmasını talep ediyorsa, bu durumda karşı tarafın (bakım borçlusunun) kabulü veya bir mahkeme kararı zorunludur.

#### 3. Sistematik İlişkiler

- **TBK m. 611 (Ölünceye Kadar Bakma Sözleşmesinin Tanımı)**: İpotek hakkının doğumu için ön şart, TBK m. 611 ve devamındaki şekil şartlarına (miras sözleşmesi veya resmi vasiyetname şekli) uygun bir sözleşmenin varlığıdır [2, 9].
- **TMK m. 893 ve m. 894 (Tescile Tabi Kanuni İpotekler)**: TBK m. 613'teki "satıcı gibi" ibaresi, TMK m. 893/1-b.1 ve TMK m. 894 ile organik bir bütünlük oluşturur [5, 6]. TMK m. 894 uyarınca bu ipoteğin "mülkiyetin naklini izleyen üç ay içinde" tapu kütüğüne tescil edilmiş olması emredici bir kuraldır. Üç aylık sürenin kaçırılması halinde, yasal ipotek hakkı düşer.
- **İcra ve İflas Kanunu Bağlantısı**: Kurulan bu ipotek, borçlunun iflası veya haczi durumlarında bakım alacaklısına rüçhan (öncelik) hakkı sağlar. Bakım alacaklısı iflas halinde, TBK m. 619/2 uyarınca, dönemsel gelirin anapara değerine eşit bir parayı iflas masasına kaydettirme hakkını elde eder ve bu alacak, kurulan ipotek sayesinde rehinli alacak statüsünde işlem görür.
...
Yukarıdaki olayda (A), sözleşmenin kurulması ve tapu devrinin üzerinden 6 ay geçtikten sonra, (B)'nin kendisine olan davranışlarının değişmesi üzerine endişeye kapılmış ve tapu müdürlüğüne giderek kanuni ipotek hakkının tescil edilmesini talep etmiştir.
*Hukuki analiz:* TMK m. 894 hükmü açıkça satıcının yasal ipotek hakkının mülkiyetin naklini izleyen 3 ay içinde tescil edilmesini emretmektedir. Uygulamada bu süre bir hak düşürücü süre niteliğindedir. 3 aylık süre geçirildiği için (A)'nın tek taraflı beyanla yasal ipotek kurma hakkı ortadan kalkmıştır. (A), ancak (B) ile anlaşarak iradi bir ipotek kurabilir veya bakım edimi ihlal ediliyorsa TBK m. 617 uyarınca sözleşmenin feshi yoluna gidebilir.

#### 6. Pratik Uygulama Notları

- **İspat Yükü**: Yasal ipotek tesisinde tapu müdürü, ölünceye kadar bakma sözleşmesinin varlığını ve taşınmazın mülkiyetinin bu sözleşme uyarınca devredildiğini re'sen gözetir. Tescil için geçerli resmi senedin varlığı tek başına ispat için yeterlidir.
- **Zamanaşımı / Süreler**: Kanuni ipotek hakkının tek taraflı kullanılabilmesi için, taşınmazın devri (işlem) tarihinden itibaren en geç **3 ay** içerisinde tapuya tescil isteminde bulunulması zorunludur [6, 10, 15]. Bu süre hak düşürücü süredir.
- **Harç ve Masraflar**: Kanuni ipotek tesisi talebinde bulunulduğunda, teminat gösterilecek miktar üzerinden binde 4,55 oranında tapu harcı ve binde 9,48 oranında damga vergisi tahsil edilir [10, 15].
- **Yaygın Uygulama Hataları**: Uygulamada sıklıkla yapılan en büyük hata, yasal ipoteğin kanundan doğduğu gerekçesiyle kendiliğinden mevcut olduğunun zannedilmesidir. Oysa TMK m. 892'nin istisnası olarak, bu ipotek "tescile tabi" kanuni ipoteklerdendir. İpotek tescil edilmediği takdirde, bakım borçlusu taşınmazı iyiniyetli üçüncü bir kişiye devrederse (TMK m. 1023), bakım alacaklısının o taşınmaz üzerindeki tüm teminatı yok olacaktır. Diğer bir hata ise ipotek bedelinin belirlenmesinde yaşanır; harca esas değerden daha yüksek bir teminat bedeli talep edilecekse borçlunun rızası olmadan işlem yapılamayacağı hususu çoğu zaman gözden kaçırılmaktadır.
