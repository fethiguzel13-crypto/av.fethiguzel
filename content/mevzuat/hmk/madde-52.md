...
hürriyetlerinin (Anayasa m. 36) güvence altına alındığını savunmaktadır. Bu
...
(organik iradeyi) açıklaması mahiyetinde olduğunu belirtmektedir.
...
(özen borcunu) doğuracağını usuli bir kural olarak hatırlatmaktadır.
...
pratik geçiş mekanizmalarının düzenlenmemiş olmasını eleştirmektedir.
