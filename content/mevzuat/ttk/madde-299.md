...
"Geçici olarak dağıtabilirler" ifadesi iki hususa işaret eder: 
Birincisi, bu ödeme nihai bir tasfiye payı dağıtımı değildir. Tasfiyenin sonunda hazırlanacak kati bilanço (TTK m. 289, 300) [4, 9] neticesinde kesinleşecek tasfiye payından mahsup edilmek üzere verilen bir nevi "tasfiye avansı" niteliğindedir.
İkincisi, bu yetki tasfiye memurunun takdirine bırakılmıştır ("dağıtabilirler"). Ortaklar, tüm şartlar gerçekleşse dahi geçici dağıtım yapılması için tasfiye memurunu kural olarak zorlayamazlar; ancak tasfiye memurunun bu takdir yetkisini objektif sınırlar içinde, dürüstlük kuralına ve ortakların eşit işlemi prensibine uygun kullanması gerekir. Geçici dağıtım sonrasında alıkonulan tutarların muhtemel borçları karşılamaya yetmediği ortaya çıkarsa, ortaklar kendilerine yapılan bu geçici ödemeyi sebepsiz zenginleşme veya şirket alacaklılarının rüçhan hakkı (TTK m. 271) kuralları gereği şirkete iade etmek zorundadırlar [1].
