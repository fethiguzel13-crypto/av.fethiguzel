...
1. **İşveren Tasarrufu:** Eylemin doğrudan işveren veya işveren vekili tarafından (kendi kararıyla veya üyesi olduğu işveren sendikasının kararıyla) yapılması gerekir.
2. **Toplu İşten Uzaklaştırma:** İşçilerin işyerine girmesinin ve çalışmasının engellenmesi, işyerinden uzaklaştırılması gerekir.
3. **Faaliyetin Tamamen Durması:** Uzaklaştırmanın, işyerinde faaliyetin tamamen durmasına yol açacak tarzda olması şarttır. Kısmi uzaklaştırmalar lokavt tanımına girmez.
4. **Amaç:** İşçiler üzerinde ekonomik baskı kurarak TİS şartlarında anlaşmaya zorlamak.
