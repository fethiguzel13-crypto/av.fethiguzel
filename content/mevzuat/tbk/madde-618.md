...
1. Alacaklının ölümü sözleşmeyi bitirir, ancak borçlunun ölümü sözleşmeyi bitirmez, borç mirasçılara geçer [2, 3].
2. Kanun, alacaklıyı arzusu hilafına borçlunun mirasçılarıyla bir arada yaşamaya icbar etmemek için m. 518 (yeni m. 618) fesih hakkını tanımıştır [2, 3].
3. Kanun, m. 516 ve m. 517'den (yeni m. 616 ve m. 617) farklı olarak m. 518'de "verilen şeyin geri alınmasından" bahsetmemiştir. Alacaklının, kendisine senelerce bakmış olan borçlusunun mirasçılarının elinden malı geri alması arzu edilmemiştir [5, 7].
4. Sonuç itibarıyla, borçlunun ölümü üzerine akdi fesheden alacaklı, in'ikad sırasında verdiği malı (örneğin tapuyu) *geri isteyemez*. Sadece iflas masasından isteyebileceği miktara müsavi bir meblağı (muteber bir irat sandığında kaydı hayat ile irat tesisi için muktazi resülmale müsavi parayı) talep edebilir [8-10, 13].
