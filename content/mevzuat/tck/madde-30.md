...
Birinci fıkrada geçen **"suçun kanuni tanımındaki maddi unsurlar"** ifadesi, suç tipini oluşturan objektif (dış dünyada gerçekleşen) bütün unsurları kapsamaktadır. Bunlar; **fiil**, **fail**, **mağdur**, **konu** (maddi konu), **netice**, **nedensellik bağı** ve kanun tarafından açıkça öngörülmüş olan **durum ve koşullar**dır. Failin bu unsurlardan herhangi biri hakkında yanlış bir tasavvurda bulunması ya da hiçbir bilgiye sahip olmaması hâlinde m. 30/1 devreye girer.
