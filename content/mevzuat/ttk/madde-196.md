...
1. TTK m. 195 kapsamında bir şirketin diğerine "hâkim" (ana şirket) olup olmadığının saptanması [4],
2. TTK m. 197 kapsamında şirketler arasında "karşılıklı iştirak" durumunun tespit edilmesi [5],
3. TTK m. 198 uyarınca kanuni "bildirim, tescil ve ilan" yükümlülüklerini doğuran eşiklerin (örneğin %5, %10, %50, %100 vb.) aşılıp aşılmadığının belirlenmesi [6], [7].
