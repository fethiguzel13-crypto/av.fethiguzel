...
- **1. Baraj: İşkolu Barajı (Ulusal Çoğunluk):** İşçi sendikasının, kurulu bulunduğu işkolunda çalışan toplam işçilerin **en az yüzde birini (%1)** üye kaydetmiş olması gerekir. İşkolu barajını aşamayan sendika, işyerinde %100 çoğunluğa sahip olsa dahi yetki alamaz ve TİS yapamaz.
- **2. Baraj: İşyeri veya İşletme Çoğunluğu (Lokal Çoğunluk):**
  - **İşyeri düzeyinde:** Başvuru tarihinde işyerinde çalışan işçilerin **yarıdan fazlasının (yüzde elli artı bir)** üye olması gerekir.
  - **İşletme düzeyinde:** İşletmeye bağlı tüm işyerleri bir bütün olarak dikkate alınır ve toplam işçilerin **en az yüzde kırkının (%40)** üye olması gerekir.
  - **İşletmede Çokluk Yarışı (Fıkra 3):** İşletmede birden fazla sendika %40 barajını aşmışsa, başvuru tarihinde en çok üyeye sahip sendika yetkili olur.

##### 2.2. Bakanlık İstatistikleri ve İtiraz Usulü (Fıkra 5, 6, 7)
- **Ocak ve Temmuz İstatistikleri:** İşkolundaki işçi sayısı ile sendika üye sayıları Bakanlıkça yılda iki kez yayımlanır. Bu istatistikler, yeni istatistik yayımlanana kadar bağlayıcıdır. Yetki başvurusu tarihindeki istatistik esas alınır; sonradan yayımlanan istatistik yetki sürecini etkilemez.
- **Yargısal Denetim:** İstatistiklerin gerçeği yansıtmadığı gerekçesiyle yayımdan itibaren **15 gün içinde Ankara İş Mahkemesinde** dava açılabilir.
- **Hızlandırılmış Yargılama (7036 sayılı Kanun Değişikliği):** Ankara İş Mahkemesi itirazı 15 gün içinde karara bağlar. İstinaf başvurusu halinde Bölge Adliye Mahkemesi 1 ay içinde, temyiz halinde ise Yargıtay 1 ay içinde **kesin olarak** karar verir. Bu hızlı süreler yargı sistemindeki tıkanıklıkları aşmayı amaçlar.

#### 3. Sistematik İlişkiler

- **Anayasa m. 53:** TİS hakkı; yetki barajları bu hakkın kullanımını doğrudan sınırlandıran en önemli yasal engellerdir.
- **STİSK m. 34:** TİS'in düzeyi; işletme düzeyinde TİS yapma zorunluluğu ile m. 41'deki %40 işletme barajı entegre çalışır.
- **STİSK m. 42-44:** Yetki tespiti usulü; çoğunluk tespitinin idari süreçlerini düzenler.
...
- **Başvuru Tarihinin Esas Alınması:** Yetki tespitinde üye sayısı ve çalışan işçi sayısı kesinlikle "yetki başvurusunun yapıldığı tarih" esas alınarak hesaplanır. Başvuru tarihinden sonraki üye istifaları veya yeni üyelikler çoğunluk hesabını etkilemez.
- **İşçi Sayısının Tespiti:** SGK kayıtları esas alınmakla birlikte, fiilen işyerinde çalışmadığı halde kayıtlarda görünen (örneğin devir, istifa veya ölüm nedeniyle ayrılmış ancak çıkışı yapılmamış) kişiler yargılama aşamasında yapılacak bilirkişi incelemesiyle elenir ve gerçek çalışan sayısı bulunur.

#### 5. Pratik Uygulama Notları

- **Ocak-Temmuz Geçiş Dönemleri:** Sendikalar yetki başvurularını yaparken istatistiklerin yayımlanma tarihlerini (Genellikle Ocak ve Temmuz sonu) yakından takip etmelidir. Sınırda olan sendikalar, lehlerine olan istatistik döneminde başvuru yapmayı tercih ederler.
- **İşkolu Tespit Davaları:** Bir işyerinin işkolunun değişmesi, sendikanın yetki barajını doğrudan etkileyebileceğinden, işkolu tespit davaları yetki süreçlerini askıya alabilir veya durdurabilir.
...
- *Doktrin:* Sarper Süzek (İş Hukuku), Nuri Çelik (İş Hukuku Dersleri), Talat Canbolat (Toplu İş Sözleşmesi Yetkisi).
- *Mevzuat:* 6356 sayılı STİSK m. 41, 7036 sayılı İş Mahkemeleri Kanunu m. 33, 2709 sayılı Anayasa m. 53.
