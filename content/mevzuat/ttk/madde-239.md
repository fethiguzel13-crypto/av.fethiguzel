---
title: "Türk Ticaret Kanunu Madde 239"
...
- **TTK m. 125 ve TMK m. 48**: Ticaret şirketlerinin tüzel kişiliğini ve hak ehliyetini düzenleyen bu kurallar, TTK m. 239'daki ayrımın felsefi ve hukuki temelidir [3, 5]. Tüzel kişilik var oldukça, malvarlığı da ona aittir.
- **TTK m. 133**: Ortakların kişisel alacaklılarının, haklarını ancak şirketin bilançosu gereğince borçlu ortağa düşen kâr payından veya şirket fesholunmuşsa tasfiye payından alabileceğini hükme bağlar [7, 13]. TTK m. 239, aslında iflas halindeki tasfiye payının beklenmesi gerektiğinin özel bir yansımasıdır.
- **TTK m. 237 ve m. 236**: Şirketin borç ve taahhütlerinden dolayı birinci derecede şirketin sorumlu olduğu, ortakların ise müteselsilen ve bütün malvarlıklarıyla sorumlu oldukları belirtilir. Yani şirket alacaklısı ortağın kişisel malvarlığına gidebilirken (ikinci derecede), ortağın kişisel alacaklısı şirketin malvarlığına hiçbir derecede gidemez [6, 7].
- **TTK m. 240**: Şirketin iflasının, kural olarak ortakların iflasını gerektirmeyeceği kuralı, tüzel kişi ile gerçek kişi ortaklar arasındaki kesin ayrımın bir başka ispatıdır [1, 8].
...
**Olay 1 (Kişisel Alacaklının Şirket Malına Haciz Girişimi):**
A, B ve C'nin ortak olduğu (X) Kollektif Şirketi, ekonomik darboğaza girerek iflas etmiştir. Ortak A'nın ise şirketten tamamen bağımsız ticari işleri sebebiyle (Y) Bankasına 1 Milyon TL şahsi kredi borcu bulunmaktadır. Şirketin iflas masasında 3 Milyon TL nakit ve gayrimenkul bulunurken, şirket alacaklılarının toplam alacağı 4 Milyon TL'dir. (Y) Bankası, iflas masasına başvurarak A'nın ortaklık payına binaen 1 Milyon TL'nin kendisine ödenmesini talep eder.
*Hukuki analiz:* TTK m. 239 uyarınca (Y) Bankasının bu talebi iflas idaresince derhal reddedilmelidir [1, 2]. Şirketin iflası halinde, şirket malvarlığı öncelikle 4 Milyon TL'lik şirket borçlarına tahsis edilir. Şirket alacaklıları tatmin edilmedikçe, ortak A'nın kişisel alacaklısı olan (Y) Bankası masadan hiçbir ödeme alamaz. Olayda şirket pasifi aktifinden fazla olduğu için, (Y) Bankası yönünden şirketten elde edilecek bir tasfiye payı da (TTK m. 133) doğmayacaktır [7, 13].

**Olay 2 (İflasta Artan Malvarlığı/Tasfiye Payı):**
Yukarıdaki örnekte (X) Kollektif Şirketinin iflas masasında 5 Milyon TL bulunduğunu ve şirket borçlarının 2 Milyon TL olduğunu varsayalım. Şirket alacaklıları tamamen ödenmiş, masada 3 Milyon TL artmıştır.
*Hukuki analiz:* Şirket alacaklıları alacaklarını tamamen aldıktan sonra (TTK m. 239 şartı gerçekleştiğinde), iflas süreci tasfiye aşamasına dönüşür ve artan bakiye, ortakların sermaye koyma oranlarına göre tasfiye payı olarak dağıtılır [1, 13, 14]. İşte bu aşamada (Y) Bankası, borçlusu A'ya düşecek olan tasfiye payı (örneğin 1 Milyon TL) üzerinde haciz tatbik ettirebilir ve alacağını bu paydan tahsil edebilir.

#### 6. Pratik Uygulama Notları
- **İspat yükü**: İflas idaresine başvuran alacaklının, alacağının bizzat şirket tüzel kişiliğinden doğduğunu sözleşme, fatura veya kesinleşmiş yargı kararı ile ispat etmesi gerekir. Ortağın şahsi işlemlerinden doğan borçlar, senedin üzerinde şirketi bağlayıcı bir kaşe/imza (temsil yetkisi dâhilinde) yoksa şirket borcu kabul edilemez.
- **Zamanaşımı / Süreler**: İflas davası ve masaya alacak kaydı işlemleri İcra ve İflas Kanunu'ndaki hak düşürücü sürelere ve usullere tabidir. Tasfiye payının haczi işlemi ise İİK ve TTK m. 133 hükümlerindeki usullerle yürütülür [7, 13].
- **Görevli/yetkili mahkeme**: Ticaret şirketlerinin iflası ve ticaret sicilinden doğan uyuşmazlıklarda görevli mahkeme, davanın değerine bakılmaksızın Asliye Ticaret Mahkemesidir. Sıra cetveline itiraz veya iflas idaresinin işlemlerine şikâyet hallerinde ise İcra Hukuk Mahkemeleri devreye girer.
- **Yaygın uygulama hataları**: Uygulamada, İcra dairelerinin şahıs şirketlerinin tüzel kişiliğini göz ardı ederek, salt ortağın borcundan dolayı ortaklık mallarına doğrudan muhafaza tedbiri uygulaması en sık rastlanan usul ve yasa hatasıdır. Bu durumda icra memurunun işlemi şikâyet yoluyla iptal ettirilir.
