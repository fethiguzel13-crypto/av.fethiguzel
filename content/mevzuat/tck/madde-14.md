...
| Tür | Açıklama | Örnek |
|---|---|---|
| **Gerçek seçimlik ceza** | Kanun, hapis ya da adli para cezasından birini öngörmekte; hangisinin uygulanacağını hâkime bırakmaktadır. | TCK m. 341 |
| **Görünürde seçimlik ceza** | Hapis cezasının adli para cezasına çevrilmesi halinde benzer bir sonuç doğmakla birlikte, bu teknik olarak seçimlik ceza değildir. | TCK m. 50 kapsamındaki dönüşüm |
...
Bu ifade, söz konusu engelin hem **soruşturma** hem de **kovuşturma** aşamasında geçerli olduğunu göstermektedir. Dolayısıyla bu, hem savcılık hem de mahkeme açısından bağlayıcı bir **mutlak kovuşturmazlık engeli**dir.
