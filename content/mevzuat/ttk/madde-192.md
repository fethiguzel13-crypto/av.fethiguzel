...
- **Yaygın uygulama hataları**: 
  1) Davacıların ortaklık paylarının uygun belirlenmemesi iddiasıyla (salt miktar uyuşmazlığı) iptal davası (m. 192) açmaları. Hâlbuki bu durumda işlemi iptal ettirmek yerine TTK m. 191 uyarınca denkleştirme davası açılmalıdır [23], [36].
  2) Terditli (kademeli) taleplerin usulüne uygun yapılandırılmaması. İptal ve denkleştirme davalarının terditli açıldığı durumlarda, öncelikle iptal incelenmeli, iptal reddedilirse denkleştirme değerlendirilmelidir [37], [38].
  3) Mahkemelerin eksikliklerin giderilmesi için taraflara süre verme (TTK m. 192/3) zorunluluğunu göz ardı ederek doğrudan iptale hükmetmeleri.
