...
*Hukuki analiz:* Bu durum TTK m. 380 kapsamında mutlak bir "finansal yardım yasağı" (kanuna karşı hile) ihlalidir ve batıldır [7, 11]. Aynı zamanda, şirketin kendi payını teminat (rehin) olarak kabul etmesi bağlamında TTK m. 379 vd. sınırları aşılmıştır [5]. TTK m. 385'e göre, şirketin bu geçersiz sözleşmeye dayanan rehni altı ay içerisinde kaldırması gerekmektedir [4]. Rehnin tasfiye edilmemesi durumunda yönetim organı yine sorumlulukla yüzleşecektir.
