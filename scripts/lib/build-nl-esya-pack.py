...
OUT = ROOT / "docs" / "ders-notlari" / "notebooklm" / "dalga-a-esya-hukuku"
GRAPH = ROOT / "lib" / "ders-notlari" / "graphs" / "esya-hukuku.json"
...
def main() -> None:
    ...
    parts = ["# Eşya hukuku — resmi lafız (FSEK m. 31)\n", "Şerh yoktur. TMK + KMK.\n"]
    seen = set()
...
Quiz TMK/KMK lafzı ve graf unsura dayanır. Künye uydurulmaz. Slayt yoktur.

Kurum id: zilyetlik, tapu, mulkiyet, payli-mulkiyet, irtifak, ipotek, tasinir-rehin, kat-mulkiyeti.

Tuzaklar: zilyetlik/mülkiyet; sicile güven/yolsuz tescil; paylı/elbirliği; intifa/kira; ipotek belirliliği; teslim/tescil; kat mülkiyeti/paylı mülkiyet.
